...
/** ----------------------- ILUMINACIÓN PREMIUM (BLENDER STYLE) ----------------------- **/

// Color Management tipo Blender (Filmic)
renderer.toneMapping = THREE.ACESFilmicToneMapping;
renderer.toneMappingExposure = 1.4;
renderer.outputColorSpace = THREE.SRGBColorSpace;

// Fondo negro para que resalten los colores pastel
scene.background = new THREE.Color(0x000000);

// ---------- HDRI ----------
new RGBELoader()
  .setPath("/textures/hdri/") 
  .load("kiara_1_dawn_4k.hdr", function (hdrMap) {
...
// ---------- LUZ SUAVE ROSA (similar a Blender) ----------
const pinkLight = new THREE.DirectionalLight(0xff7ac7, 2.2);
pinkLight.position.set(5, 10, 5);
pinkLight.castShadow = true;

pinkLight.shadow.mapSize.width = 2048;
pinkLight.shadow.mapSize.height = 2048;
pinkLight.shadow.bias = -0.0005;

scene.add(pinkLight);

// ---------- LUZ DE RELLENO AZUL ----------
const blueFill = new THREE.DirectionalLight(0x7acbff, 1.2);
blueFill.position.set(-5, 6, -5);
scene.add(blueFill);
